...
import CeoApprovedList from "../accountantDashboard/CeoApprovedList";
        ...
        <div className="card-content">
          <div className="content">
            <form onSubmit={updateRequest} >
              ...
              <div className="field">
                ...
                <div className="control">
                  ...
                  >
                    ...
                    <option value="Sorry! but your request have been turn down by your Manager"> Decline</option>
                  </select>
                </div>
              </div>
              ...
              <div className="field">
                <div className="control">
                  <button type="submit" className="button is-#4C0033" style={btnn}>
                    Respond
                  </button>
                </div>
              </div>
